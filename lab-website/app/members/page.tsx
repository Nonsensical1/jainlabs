        ...
        <div className="bg-background/80 backdrop-blur-sm p-8 md:p-12 rounded-2xl border border-border/50">
          ...
          <section className="mt-12">
            ...
            <div className="mt-6 space-y-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                <div className="w-32 h-32 md:w-40 md:h-40 shrink-0 bg-muted rounded-md overflow-hidden relative">
                  <Image src="/Member-headshots/Dhruv2.jpg" alt="Dhruv Champaneri" fill sizes="(max-width: 768px) 128px, 160px" className="object-cover" />
                </div>
                <div>
            ...
            <div className="mt-6 space-y-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                ...
                <div>
                  ...
                  <p className="mt-4 text-muted-foreground leading-relaxed">
                    Elijah works under Boyu Huang, creating Cas-tools and discovering novel genetic engineering systems, while specializing in molecular genetics, computational biology, software engineering, and evolutionary biology.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-6 space-y-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                ...
                <div>
                  ...
                  <p className="mt-4 text-muted-foreground leading-relaxed">
                    August graduated from UF with a Bachelor&apos;s degree in chemical engineering. While in the lab, August worked on developing various nucleic acid detection methods.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-foreground mt-1">Major: Chemical Engineering</p>
                  <p className="mt-4 text-muted-foreground leading-relaxed">
                    Yasmin worked on developing bioinformatics pipelines and assisted with the development of novel precise RNA editing technologies.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-foreground mt-1">Major: Biochemistry</p>
                  <p className="mt-4 text-muted-foreground leading-relaxed">
                    Anne worked on developing novel multiplexed CRISPR-based detection platforms and Psi-DNA.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-foreground mt-1">Major: Chemical Engineering</p>
                  <p className="mt-4 text-muted-foreground leading-relaxed">
                    Ian worked on the development of various nucleic acid detection methods.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-foreground mt-1">Major: Chemical Engineering</p>
                  <p className="mt-4 text-muted-foreground leading-relaxed">
                    Jordan worked on multiple projects including the development of various RNA detection methods.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                ...
                <div>
                  ...
                  <p className="mt-4 text-muted-foreground leading-relaxed">
                    Coleen worked on utilizing CRISPR/Cas9 to edit antibiotic resistance genes in E. coli.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start border-b border-border pb-8 last:border-0">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-foreground mt-1">MS: University of Florida (Chemical Engineering)</p>
                  <p className="mt-4 text-muted-foreground leading-relaxed">
                    Victor worked on the semi-comprehensive development of inexpensive prototypes for in-field use, designed to complement biomolecular assays and protocols developed by the lab.
                  </p>
                </div>
              </div>
